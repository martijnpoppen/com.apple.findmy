...
function AuthInit(authenticator) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const initResponse = yield fetch(AUTH_ENDPOINT + 'signin/init', Object.assign({ headers: AUTH_HEADERS, method: 'POST', body: JSON.stringify(initData) }, fetchOptions));
        if (!initResponse.ok) {
...
function AuthComplete(authenticator, password, initResponse) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const authData = Object.assign(Object.assign({}, completeData), { trustTokens: [], rememberMe: true, pause2FA: true });
        const completeResponse = yield fetch(AUTH_ENDPOINT + 'signin/complete', Object.assign({ headers: AUTH_HEADERS, method: 'POST', body: JSON.stringify(authData) }, fetchOptions));
