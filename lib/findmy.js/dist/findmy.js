...
export class FindMy {
    ...
    authenticate(username, password) {
        return __awaiter(this, void 0, void 0, function* () {
            const resp1 = yield fetch('https://ip6.me/api/', Object.assign({ method: 'GET' }, fetchOptions));
            const resp2 = yield fetch('https://ip6.me/api/', {});
            console.log('[Authenticate] with enforce ipv4', yield resp1.text());
            console.log('[Authenticate] without enforce ', yield resp2.text());
