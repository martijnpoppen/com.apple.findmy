...
export class FindMy {
     ...
     */
    renewFromTokens(tokens) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            if (!(tokens === null || tokens === void 0 ? void 0 : tokens.sessionToken))
                return false;
            const renewed = yield RenewFindMySession({
                cookies: new CookieJar(),
                accountInfo: {},
                trustToken: (_a = tokens.trustToken) !== null && _a !== void 0 ? _a : '',
                sessionToken: tokens.sessionToken,
                accountCountry: (_b = tokens.accountCountry) !== null && _b !== void 0 ? _b : '',
            });
            if (!renewed)
                return false;
