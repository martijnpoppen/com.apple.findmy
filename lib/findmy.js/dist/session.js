...
export class FindMySession {
    ...
    connect() {
        return __awaiter(this, arguments, void 0, function* ({ forceLogin = false } = {}) {
            ...
            const stored = forceLogin ? null : yield this.loadStored();
            if (stored) {
                try {
                    findmy.importSession(stored);
                    if (yield findmy.validateSession()) {
            ...
            try {
                ...
                yield findmy.authenticate(this.username, this.password, stored === null || stored === void 0 ? void 0 : stored.trustToken);
            }
            catch (error) {
                this.findmy = null;
                if (isTransientNetworkError(error)) {
